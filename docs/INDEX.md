...
| v0.3.2.2 | ✅ 已完成 | 系统设置：爬虫 Cookie 管理 |
| v0.3.3 | ✅ 已完成 | AI 仿写生成（F-005-1） |
| v0.3.3.1 | ✅ 已完成 | AI 直接创作入口（F-005-1 直接创作）|
| v0.3.4 | ✅ 已完成 | 拆解列表页（F-003-3）|
| v0.4.0 | ✅ 已完成 | AI 仿写完善（F-005-1 对齐 + F-005-2 标记最终稿）|
| v0.4.0 | 🏗 开发中 | F-005-1 对齐验证 + F-005-2 标记最终稿（合并 v0.4.0+v0.4.1）|
## 快速指令
