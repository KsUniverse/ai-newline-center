...
export function AccountCard({ account, onClick }: AccountCardProps) {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="group relative flex h-full w-full flex-col overflow-hidden rounded-xl border border-border/55 bg-card/90 p-5 text-left transition-all hover:-translate-y-0.5 hover:border-primary/30 hover:bg-card"
    >
