        ...
        <div className="min-w-0 flex-1 space-y-1">
          ...
          {item.experienceSummary ? (
            <div className="flex items-center gap-1 pt-0.5">
              ...
              <span className="text-2xs font-medium text-emerald-600">已积累经验</span>
              <span className="text-2xs text-muted-foreground/60">
                · 播放 {item.experienceSummary.playsCount.toLocaleString()} · 赞{" "}
                {item.experienceSummary.likesCount.toLocaleString()}
              </span>
            </div>
          ) : null}
        </div>
