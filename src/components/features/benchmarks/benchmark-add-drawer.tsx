...
export function BenchmarkAddDrawer({ open, onOpenChange, onSuccess }: BenchmarkAddDrawerProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={handleOpenChange}>
      <SheetContent side="right" className="w-full border-l border-border/55 bg-card/95 p-0 sm:max-w-lg">
        <div className="flex h-full flex-col">
          ...
          <div className="flex-1 space-y-6 overflow-y-auto px-6 py-6">
                ...
                <div
                  className={cn(
                    ...
                    urlError
                      ...
                      : "border-border/55 bg-card/90 focus-within:border-primary/30 focus-within:bg-card focus-within:ring-4 focus-within:ring-primary/8",
                  )}
                >
                  <span
                    className={cn(
                      ...
                      urlError
                        ...
                        : "border-border/55 bg-background/90 text-primary",
                    )}
                  >
            ...
            <div className="rounded-lg border border-border/55 bg-card/80 p-4">
            ...
            {isFetching ? (
              <div className="flex min-h-52 flex-col items-center justify-center rounded-xl border border-border/55 bg-card/80 px-6 py-8 text-center">
            ...
            {(step === "PREVIEW" || isSubmitting) && preview ? (
              <div className="space-y-4 rounded-xl border border-border/55 bg-card/80 p-5">
                <div className="space-y-1">
                  <p className="text-2xs font-medium uppercase tracking-[0.18em] text-primary/80">
                    Preview
                  </p>
                ...
                <div className="flex items-center gap-4 rounded-lg border border-border/55 bg-background/80 p-4">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src={proxyImageUrl(preview.avatar)}
                    alt={preview.nickname}
                    className="h-14 w-14 rounded-full border border-border/45 bg-muted object-cover"
                  />
          ...
          <div className="border-t border-border/35 px-6 py-5">
